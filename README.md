...
快贝智单 QuickBillMate 是一款面向小微商户和建材/日杂销售场景的 **Android 销售清单生成器**。在手机上填写客户与单据信息、勾选商品，即可实时预览销售清单，并一键导出为高清 PNG 图片——保存到相册或直接分享给微信、QQ 等。
...
- **图片样式**：内置 4 套预设（经典单据、经典单据（简洁）、简洁现代、商务蓝），支持自定义。
